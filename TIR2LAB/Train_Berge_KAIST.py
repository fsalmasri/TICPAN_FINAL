...
def train(args, device):
    ...
    train_loader = DataLoader(dataset=DatasetFromFolder(args.Dataset, set='train'), num_workers=5, batch_size=8, shuffle=True)
    val_loader = DataLoader(dataset=DatasetFromFolder(args.Dataset, set='valid'), num_workers=5, batch_size=1, shuffle=False)
    ...
    for epoch in range(0, args.num_epochs, 1):
        ...
        totalLoss.append([running_results['loss'] / running_results['batch_sizes']])
