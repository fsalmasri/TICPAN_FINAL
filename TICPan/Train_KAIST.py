...
from models.myGVSIFTI3 import Model
from Helpers.KAIST_DataLoader_feras import *
from Helpers.Layers.GaussianLayer import GaussianLayer
from Helpers.utilities import SaveData, validation_methods


path = '/home/falmasri/Desktop/ptest/dataset/Timg/KAISt-MS-day-3th.pkl'
# path = '/home/falmasri/Desktop/ptest/dataset/Timg/KAISt-MS-night-test.pkl'

parser = argparse.ArgumentParser(description='Colorizing KAIAST using GVSIFTI')
parser.add_argument('--num_epochs', default=1000, type=int, help='train epoch number')
parser.add_argument('--GPUid', default='0', type=int, help='GPU ID')
parser.add_argument('--Dataset', default=path,
                    type=str, help='Path to dataset')
parser.add_argument('--Mode', default='train', type=str, help='train or test')
parser.add_argument('--Checkpoint', default='default', type=str, help='Path to checkpoint for training')
parser.add_argument('--Folder', default='Feras/AB_HF_KAIST_L1_11_ablation6D0.3', type=str, help='Saving folder')
